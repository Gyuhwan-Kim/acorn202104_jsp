...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	// ?num=x   num이라는 parameter로 전달되는 문자열을 읽어와서 숫자로 바꾼다.
	int num=Integer.parseInt(request.getParameter("num"));
	System.out.println(num+" 번 회원의 정보를 삭제합니다.");	
...
<body>
	...
	<%}else{ %>
		<p class="alert alert-danger d-flex align-items-center" role="alert">
			...
			회원 정보를 삭제하지 못했습니다. 다시 시도해주세요.
			<a class="alert-link"  href="list.jsp">다시 시도</a>
		</p>
	<%} %>
</body>
</html>