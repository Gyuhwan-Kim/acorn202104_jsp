...
<%
	...
	// <input type="file" name="image"/> 을 통해서 upload된 file을 access 할 수 있는 File 객체
...
<body>
	...
	<p> 서버의 file system에서 저장된 실제 경로 : <strong><%=path %></strong></p>

	<a href="download.jsp?fileSize=<%=fileSize%>&orgFileName=<%=orgFileName%>&saveFileName=<%=saveFileName%>">방금 upload한 file download test</a>
	<h1>방금 upload한 image</h1>
