...
<body>
	<div class="container">
		...
		<form action="signup.jsp" method="post" id="myForm">
			<div>
				...
				<small class="form-text text-muted">영문 소문자로 시작하고, 5~10 글자 이내로 입력하세요.</small>
			...
			<div>
				...
				<div class="invalid-feedback">이메일을 확인하세요</div>
			</div>
	...
	<script>
		...
		document.querySelector("#id").addEventListener("input", function(){
			// 일단 is-invalid, is-valid class를 제거한다.
